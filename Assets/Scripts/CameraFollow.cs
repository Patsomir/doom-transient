...
public class CameraFollow : MonoBehaviour {
    ...
    void Update() {
        ...
        Vector3 movementOffset = new Vector3(0, amp * Mathf.Sin(Time.time * frequancy), 0) * isMoving;
        transform.position = toFollow.position + initialOffset + movementOffset;
